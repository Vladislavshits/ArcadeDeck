...
class WelcomeWizard(QWizard):
    def __init__(self, parent=None):
        ...
        theme_label_font = QFont("Arial", 20)
    ...
    def handle_page_change(self, page_id):
        """Управляет видимостью кнопки 'Назад'"""
    ...
    def apply_theme(self, theme_name):
        """Применяет указанную тему через QSS"""
        try:
    ...
    def update_styles(self):
        """Обновляет стили всех виджетов после изменения темы"""
